...
public class Aluguel {
    ...
    public Aluguel(int id, String dataLocacao, String dataDevolucao, double juros, String localRetirada, String localDevolucao, int qntDiaAluguel, int idCliente, int idCarro) {
        this.id = id;
