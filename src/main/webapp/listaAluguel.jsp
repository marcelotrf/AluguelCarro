    ...
    <head>
     ...
     <script lang="text/javascript">
            function mostrarModalExclusao(id){
                console.log("mostrarModalExclusao", id, idCaro);
                $("#idCarro").html(idCarro);
                $('#idAluguel').val(id);
            ...
            <tbody>
                <c:forEach var="aluguel" items="${listaAluguel}">
                    <tr>
                        ...
                        <td>${aluguel.idCarro}</td>
                        <td><a href="AlterarAluguel?id=${aluguel.id}">Alterar</a></td>
                        <td><button type="button" class="btn btn-primary" onclick="mostrarModalExclusao('${aluguel.id}', '${aluguel.idCarro}')">Excluir</button></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
